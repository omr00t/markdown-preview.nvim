...
GH_REPO="$GH_API/repos/omr00t/markdown-preview.nvim"
...
do
  GH_ASSET="https://uploads.github.com/repos/omr00t/markdown-preview.nvim/releases/$id/assets?name=$filename"
